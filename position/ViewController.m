...
- (void)viewDidLoad {
    [super viewDidLoad];
    //讯美：22.5457358416,113.9472985268
    //北航  22.527236, 113.940955
    
//    腾讯高德：19.5390841355,110.2587890625

    //2.在进行坐标转换
    CLLocationCoordinate2D location2D = CLLocationCoordinate2DMake(22.533139423609217,114.13732482543944);
    CLLocationCoordinate2D WGSlocation2D = [self gcj02ToWgs84:location2D];
